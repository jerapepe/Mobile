...
import com.example.camara.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity(){
    ...
    // Seleccionamos la cámara trasera
        ...
        try {
            ...
            Log.e("CamaraX","Error al iniciar la camara ", exc)
    ...
    fun takePhoto() {
        ...
        imageCapture?.takePicture(outputOptions, ContextCompat.getMainExecutor(this),object : ImageCapture.OnImageSavedCallback {
            ...
            override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                Toast.makeText(baseContext,"La    imagen    ${output.savedUri}    se    guardó correctamente!",
